...
| `general.open_at_startup` | Открывать Hakutest в браузере при запуске                                         | `true` или `false`                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `test.default_task_type`  | Тип задания по умолчанию при добавлении задания в редакторе                       | `single` &mdash; Один вариант ответа<br><br>`multiple` &mdash; Несколько вариантов ответа<br><br>`open` &mdash; Открытый ответ<br><br>`detailed` &mdash; Развёрнутый ответ                                                                                                                                                                                                                                           |
| `security.student`        | Политика безопасности, применяемая к интерфейсу ученика                           | `no_verification` &mdash; [Для всех без верификации](/ru/handbook/advanced/01-security#no-verification).<br><br>`credentials` &mdash; [По имени пользователя и паролю](/ru/handbook/advanced/01-security#credentials).<br><br>`hostonly` &mdash; [Только это устройство](/ru/handbook/advanced/01-security#hostonly)<br><br>`abort_all` &mdash; [Прерывать все запросы](/ru/handbook/advanced/01-security#abort-all) |
